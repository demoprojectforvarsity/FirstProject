        ...
        var settings=$.extend({
            ...
            return this.each(function(){
                ...
                var counterUpper=function(){
                    ...
                    var decimalPlaces=(num.split(".")[1]||[]).length;if(counter.beginAt>num)counter.beginAt=num;
                                    ...
                                    var seconds=parseInt(newNum%60,10);
                                        newNum=(hours<10?"0"+hours:hours)+":"+(minutes<10?"0"+minutes:minutes)+":"+(seconds<10?"0"+seconds:seconds)}
                                            if(isComma)
                                                ...
                                                if(settings.formatter){newNum=settings.formatter.call(this,newNum)}nums.unshift(newNum)}$this.data("counterup-nums",nums);
                                                ...
                                                if($this.data("counterup-nums").length){setTimeout($this.data("counterup-func"),counter.delay)}
                                                    ...
                                                    $this.data("counterup-nums",null);$this.data("counterup-func",null);settings.callback.call(this)}};
